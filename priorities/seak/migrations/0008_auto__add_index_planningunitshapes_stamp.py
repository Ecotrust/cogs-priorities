...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PlanningUnitShapes', fields ['stamp']
        db.create_index('seak_planningunitshapes', ['stamp'])


    def backwards(self, orm):
        # Removing index on 'PlanningUnitShapes', fields ['stamp']
        db.delete_index('seak_planningunitshapes', ['stamp'])
