...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.input_geography'
        db.alter_column('seak_scenario', 'input_geography', self.gf('seak.models.JSONField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Scenario.input_geography'
        raise RuntimeError("Cannot reverse this migration. 'Scenario.input_geography' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Scenario.input_geography'
        db.alter_column('seak_scenario', 'input_geography', self.gf('seak.models.JSONField')())
    ...
    models = {
        ...
        'seak.planningunitshapes': {
            ...
            'stamp': ('django.db.models.fields.FloatField', [], {'db_index': 'True'})
        },
        'seak.puvsaux': {
        ...
        'seak.scenario': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'input_geography': ('seak.models.JSONField', [], {'null': 'True', 'blank': 'True'}),
