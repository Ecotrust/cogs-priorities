...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlanningUnitShapes.name'
        db.alter_column('seak_planningunitshapes', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'PlanningUnitShapes.name'
        db.alter_column('seak_planningunitshapes', 'name', self.gf('django.db.models.fields.CharField')(max_length=99, null=True))
