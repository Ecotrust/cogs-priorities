...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlanningUnit.name'
        db.alter_column('seak_planningunit', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PlanningUnit.name'
        db.alter_column('seak_planningunit', 'name', self.gf('django.db.models.fields.CharField')(max_length=99))
